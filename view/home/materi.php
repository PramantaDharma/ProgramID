...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow position-sticky sticky-top">

<<<<<<< HEAD
<nav class="navbar navbar-expand-lg navbar-light bg-light ">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Program ID - Materi</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
=======
...
>>>>>>> 73bf1470609057007e475d633308502e70014ec3
        </button>
...
<<<<<<< HEAD
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="#">Basic Programming</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Lihat lainnya...</a>
                </div>
            </li>
            <li class="nav-item">
...
<<<<<<< HEAD
                <div class="">
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow position-sticky">
