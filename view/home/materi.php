...
<body id="page-top">
    ...
    <!-- Category position-sticky sticky-top -->
    <div class="">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion position-relative sidebar-scroll" id="accordionSidebar">
