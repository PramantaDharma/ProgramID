        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                    <h3 class="p mb-2 text-gray-800" ></h3>
                    </div>
                    ...
                    <div>
                        <h3>Ingin belajar apa hari ini?</h3>
                    </div>
                    <div class="row mt-2">
                        <div class="d-sm-flex container-fluid row justify-content-center">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="font-weight-bold text-primary">
                                                Web programming</div>
                                            <div class="p mb-0 text-gray-800">Tutorial dasar-dasar</div>
                                        </div>
                                        <div class="col-auto">
