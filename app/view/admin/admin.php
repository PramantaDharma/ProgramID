            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <center>Amount of Material</center></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><center>4</center></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4"data-aos="fade-up"data-aos-duration="3000">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                <center>Amount of Category</center></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><center>10</center></div>
                                        </div>
                                        <div class="col-auto">
